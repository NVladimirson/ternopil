...
<div id="layoutSidenav_content">
   ...
   <div class="row">
        ...
        <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('companies.index') }}" title="К списку"> <i class="fas fa-backward "></i> </a>
            </div>
            <div class="pull-left">
        ...
        <div class="card mb-12">
                ...
                <div class="form-group">
                    <strong>Название: {{$company->title}}</strong>
                    <p></p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Создана: {{$company->created_at}}</strong>
                    <p></p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Изменена: {{$company->updated_at}}</strong>
                    <p></p>
                </div>
            </div>
