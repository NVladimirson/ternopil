        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" required placeholder="Наименование" value="{{$company->title}}">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Email:</strong>
                    <input type="text" name="email" class="form-control" required placeholder="Наименование" value="{{$company->email}}">
                </div>
            </div>

            <div class="col-xs-12 col-sm-12 col-md-12">
             <div class="form-group">
             <img src="{{asset('assets/logos/'.$company->logo)}}" style="max-height:100px;max-width:100px">
            </div>
            </div>

            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Изменить Лого:</strong>
